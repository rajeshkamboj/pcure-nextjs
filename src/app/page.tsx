            ...
            <div className="lg:col-span-5">
              {featuredDiseases.length > 0 ? (
                <div className="bg-white rounded-xl border border-[#ded6c8] shadow-md p-6 sm:p-7 relative overflow-hidden">
                  ...
                  <Link href={`/diseases/${featuredDiseases[0].slug}`} className="w-full text-center bg-[#F1ECE1] hover:bg-[#e4ddcf] text-[#1E4D30] font-semibold text-xs sm:text-sm py-2.5 rounded-md transition-colors flex items-center justify-center gap-1.5">
      ...
      <section className="py-14 sm:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-3 border-b border-[#e5dfd3]">
            ...
            <Link href="/diseases" className="mt-3 md:mt-0 text-xs sm:text-sm font-semibold text-[#1E4D30] hover:text-[#133621] flex items-center gap-1 transition-colors">
      ...
      <section className="bg-[#F3EFE6] py-14 sm:py-16 border-y border-[#E2DBD0]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-3 border-b border-[#ded5c5]">
            ...
            <Link href="/remedies" className="mt-3 md:mt-0 text-xs sm:text-sm font-semibold text-[#1E4D30] hover:text-[#133621] flex items-center gap-1 transition-colors">
      ...
      <section className="py-14 sm:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-3 border-b border-[#e5dfd3]">
            ...
            <Link href="/ingredients" className="mt-3 md:mt-0 text-xs sm:text-sm font-semibold text-[#1E4D30] hover:text-[#133621] flex items-center gap-1 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {articles.slice(0, 6).map((article) => (
              ...
              >
                <div>
                  <div className="h-48 rounded-lg overflow-hidden mb-4 border border-[#e5dfd3] relative">
                    <RemoteImage
      ...
      <section className="py-12 bg-[#FAF7F0] border-t border-[#E5DFD3]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="rounded-xl border border-[#ded5c5] bg-[#F4EFE5] p-6 sm:p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <Link href="/about" className="shrink-0 px-4 py-2 bg-white text-[#1E4D30] hover:bg-[#FAF8F5] border border-[#cfc5b4] rounded font-medium text-xs sm:text-sm transition-colors">
