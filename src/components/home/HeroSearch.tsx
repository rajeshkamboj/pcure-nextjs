...
/**
 * The only interactive part of the home hero. Everything else on the home page
 * is server-rendered; keeping this island tiny means the page ships very little JS.
 */
